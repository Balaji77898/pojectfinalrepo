...
"[project]/app/staff/staff-dashboard/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function StaffDashboard() {
    _s();
    const { role, isLoading: authLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$staff$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { orders: allOrders, isLoading: ordersLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$staff$2f$contexts$2f$OrdersContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOrders"])();
    ...
    const orders = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "StaffDashboard.useMemo[orders]": ()=>{
            return allOrders.filter({
                "StaffDashboard.useMemo[orders]": (o)=>o.status !== 'PLACED' && o.status !== 'CANCELLED'
            }["StaffDashboard.useMemo[orders]"]).slice(0, 4).map({
                "StaffDashboard.useMemo[orders]": (o)=>({
                        id: o.id,
                        table: o.table,
                        status: o.status,
                        items: o.items,
...
_s(StaffDashboard, "fZuYcQad7GAbxwEvPm60UvDGjh4=", false, function() {
    return [
...
//# sourceMappingURL=app_staff_e9f42343._.js.map