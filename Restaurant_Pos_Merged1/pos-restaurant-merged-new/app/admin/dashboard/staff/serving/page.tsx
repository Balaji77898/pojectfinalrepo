...
function ServingStaffContent() {
    ...
    // Filter serving staff only
    const servingStaff = useMemo(() => {
        return staff.filter(member => {
            const isServingStaff = member.role === StaffRole.SERVING_STAFF;
            ...
            return isServingStaff && matchesSearch && matchesStatus;
        });
    ...
    // Stats
    const stats = {
        total: servingStaff.length,
        active: servingStaff.filter(s => s.is_active).length,
        inactive: servingStaff.filter(s => !s.is_active).length,
    };
    ...
    return (
        <ProtectedRoute>
            <div className="min-h-screen bg-paper-white">
                ...
                <header className="bg-ruby-red py-8 px-8 shadow-lg border-b-4 border-gold-start">
                    <div className="max-w-7xl mx-auto">
                        ...
                        >
                            <span className="group-hover:-translate-x-1 transition-transform duration-200">←</span> Back to Staff Management
                        </Link>
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-gold-start/80">Manage floor staff and service assignments</p>
                            </div>
                            <button
                ...
                <div className="max-w-7xl mx-auto p-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        <div className="bg-white rounded-lg shadow p-4 border border-gray-100">
                            <div className="text-text-muted text-sm mb-1">Total Serving Staff</div>
                    ...
                    <div className="mb-4">
                        <p className="text-text-muted">
                            Showing <span className="font-semibold text-text-primary">{servingStaff.length}</span> serving staff member{servingStaff.length !== 1 ? 's' : ''}
                        </p>
                    </div>
            ...
            <AddStaffModal
                ...
                defaultRole={StaffRole.SERVING_STAFF}
            />
